...
```bash
docker pull ghcr.io/sqlrush/gaussdb-agent-runtime:agent-v1.1.1-oc1.18.27
```

```bash
docker pull ghcr.io/sqlrush/gaussdb-agent-kb-import:agent-v1.1.1-oc1.18.27
```

```bash
docker pull ghcr.io/sqlrush/gaussdb-agent-gateway:agent-v1.1.1-oc1.18.27
```

```bash
docker pull ghcr.io/sqlrush/gaussdb-agent-frontend:agent-v1.1.1-oc1.18.27
```
...
```bash
docker tag ghcr.io/sqlrush/gaussdb-agent-runtime:agent-v1.1.1-oc1.18.27 $REG/gaussdb-agent-runtime:agent-v1.1.1-oc1.18.27
docker tag ghcr.io/sqlrush/gaussdb-agent-kb-import:agent-v1.1.1-oc1.18.27 $REG/gaussdb-agent-kb-import:agent-v1.1.1-oc1.18.27
docker tag ghcr.io/sqlrush/gaussdb-agent-gateway:agent-v1.1.1-oc1.18.27 $REG/gaussdb-agent-gateway:agent-v1.1.1-oc1.18.27
docker tag ghcr.io/sqlrush/gaussdb-agent-frontend:agent-v1.1.1-oc1.18.27 $REG/gaussdb-agent-frontend:agent-v1.1.1-oc1.18.27
docker tag opengauss/opengauss:7.0.0-RC1 $REG/opengauss:7.0.0-RC1
```

```bash
docker push $REG/gaussdb-agent-runtime:agent-v1.1.1-oc1.18.27
docker push $REG/gaussdb-agent-kb-import:agent-v1.1.1-oc1.18.27
docker push $REG/gaussdb-agent-gateway:agent-v1.1.1-oc1.18.27
docker push $REG/gaussdb-agent-frontend:agent-v1.1.1-oc1.18.27
...
```yaml
  USER_IMAGE_TAG: "agent-v1.1.1-oc1.18.27"
```
